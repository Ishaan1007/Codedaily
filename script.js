        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-emerald-100 overflow-hidden relative">
            ...
            <div class="p-8 flex flex-col items-center text-center">
                ...
                <div class="mb-8 relative">
                    <div id="timer-display" class="text-8xl font-black text-emerald-600 font-mono tracking-tighter tabular-nums select-none">${formatTime(state.timeLeft)}</div>
                    <p id="timer-status" class="text-emerald-900/40 text-sm font-medium mt-2">${state.isTimerActive ? 'Keep coding...' : 'Paused'}</p>
                </div>
...
function getRoadmapHTML() {
    ...
    let featuresHTML = ''; // Fixed typo here
